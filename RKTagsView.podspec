...
Pod::Spec.new do |s|
  s.name             = "RKTagsView"
  s.version          = "1.3.0"
  s.summary          = "Highly customizable iOS tags view (like NSTokenField). Supports horizontal and vertical direction, editing, multiple selection, Auto Layout and much more."
